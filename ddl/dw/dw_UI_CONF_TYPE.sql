DROP TABLE IF EXISTS `borhandw`.`dwh_dim_ui_conf_type`;

CREATE TABLE `borhandw`.`dwh_dim_ui_conf_type` (
...
CREATE TRIGGER `borhandw`.`dwh_dim_ui_conf_type_setcreationtime_oninsert` BEFORE INSERT
