DROP TABLE IF EXISTS `borhandw`.`dwh_dim_entry_media_type`;

CREATE TABLE `borhandw`.`dwh_dim_entry_media_type` (
...
CREATE TRIGGER `borhandw`.`dwh_dim_entry_media_type_setcreationtime_oninsert` BEFORE INSERT
