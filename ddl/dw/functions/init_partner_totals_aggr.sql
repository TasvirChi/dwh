...
BEGIN
	...
	TRUNCATE borhandw.dwh_daily_partner_totals;
	
	INSERT INTO borhandw.dwh_daily_partner_totals(partner_id, date_id, total_entries)
	...
	INSERT INTO borhandw.dwh_daily_partner_totals(partner_id, date_id, added_entries)
	SELECT partner_id, p_the_day_before, COUNT(entry_id)
	FROM borhandw.dwh_dim_entries
	...
	INSERT INTO borhandw.dwh_daily_partner_totals(partner_id, date_id, deleted_entries)
	SELECT partner_id, p_the_day_before, COUNT(entry_id)
	FROM borhandw.dwh_dim_entries
	...
	INSERT INTO borhandw.dwh_daily_partner_totals(partner_id, date_id, total_users)
	...
	INSERT INTO borhandw.dwh_daily_partner_totals(partner_id, date_id, added_users)
	SELECT partner_id, p_the_day_before, COUNT(kuser_id)
	FROM borhandw.dwh_dim_kusers
	WHERE created_at BETWEEN DATE(p_the_day_before) AND DATE(p_the_day_before) + INTERVAL 1 DAY - INTERVAL 1 SECOND 
	...
	INSERT INTO borhandw.dwh_daily_partner_totals(partner_id, date_id, deleted_users)
	SELECT partner_id, p_the_day_before, COUNT(kuser_id)
	FROM borhandw.dwh_dim_kusers
	WHERE updated_at BETWEEN DATE(p_the_day_before) AND DATE(p_the_day_before) + INTERVAL 1 DAY - INTERVAL 1 SECOND 
	AND kuser_status_id = 2
