DROP TABLE IF EXISTS `borhandw`.`dwh_dim_moderation_status`;

CREATE TABLE `borhandw`.`dwh_dim_moderation_status` (
...
CREATE TRIGGER `borhandw`.`dwh_dim_moderation_status_setcreationtime_oninsert` BEFORE INSERT
