...
ALTER TABLE borhandw.dwh_fact_events MODIFY entry_id VARCHAR(20),  ADD COLUMN entry_partner_id INT after entry_media_type_id;

# add field on borhandw_ds.DS_Events
ALTER TABLE borhandw_ds.DS_Events MODIFY entry_id VARCHAR(20),   ADD COLUMN entry_partner_id INT after entry_media_type_id;
