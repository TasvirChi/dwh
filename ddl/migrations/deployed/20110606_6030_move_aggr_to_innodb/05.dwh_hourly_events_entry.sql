USE borhandw;
DROP TABLE IF EXISTS `dwh_hourly_events_entry_innodb`;

CREATE TABLE `dwh_hourly_events_entry_innodb` (
...
CALL borhandw.add_monthly_partition_for_table('dwh_hourly_events_entry_innodb');
