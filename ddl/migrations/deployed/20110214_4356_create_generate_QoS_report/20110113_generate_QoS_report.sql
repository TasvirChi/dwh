...
BEGIN
	...
	INSERT INTO borhandw.dwh_qos_reports (measure, classification, DATE, yesterday, the_day_before, diff, last_5_days_avg, last_30_days_avg, outer_order, inner_order)
	...
	(
		...
		FROM borhandw.dwh_dim_entry_media_type
