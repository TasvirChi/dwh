...
BEGIN
	...
	INSERT INTO borhandw_ds.updated_entries SELECT entries.entry_id, SUM(IFNULL(count_loads, 0))+IFNULL(old_entries.views,0) views, SUM(IFNULL(count_plays, 0))+IFNULL(old_entries.plays,0) plays FROM 
