...
BEGIN
	...
	INSERT INTO borhandw.dwh_billing (month_id, partner_id, partner_parent_id, plays)
	SELECT
		@current_month_id,
	...
	INSERT INTO borhandw.dwh_billing (month_id, partner_id, partner_parent_id, bandwidth_gb, livestreaming_gb)
	SELECT
		@current_month_id,
		paying_partners.partner_id,
		paying_partners.partner_parent_id,
	...
	FROM 
		borhandw.dwh_hourly_partner_usage hourly_partner_usage,
		paying_partners,
		borhandw.dwh_dim_bandwidth_source bandwidth_source
	WHERE 
