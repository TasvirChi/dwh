...
MySQL - 5.1.41-3ubuntu12.6 : Database - borhandw_ds
*********************************************************************
*/
...
insert  into `aggr_name_resolver`(`aggr_name`,`aggr_table`,`aggr_id_field`,`aggr_join_stmt`) values ('entry','dwh_aggr_events_entry','entry_id',''),('domain','dwh_aggr_events_domain','domain_id',''),('country','dwh_aggr_events_country','country_id,location_id',''),('partner','dwh_aggr_partner','',''),('widget','dwh_aggr_events_widget','widget_id',''),('uid','dwh_aggr_events_uid','kuser_id','inner join borhandw.dwh_dim_entries as entry on(ev.entry_id = entry.entry_id)');
