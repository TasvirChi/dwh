insert into borhandw_ds.processes (id,process_name, max_files_per_cycle) values (2,'fms_live_streaming', 50);
...
INSERT INTO borhandw_ds.staging_areas (id, process_id, source_table, target_table_id, staging_partition_field, post_transfer_sp, aggr_date_field, post_transfer_aggregations, hour_id_field)
