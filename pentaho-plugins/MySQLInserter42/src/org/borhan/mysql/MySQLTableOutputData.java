...
public class MySQLTableOutputData extends BaseStepData implements StepDataInterface
{
	public  Database db;
	public  int      warnings;
     ...
     */
    public  Map<String, Map<Integer,PreparedStatement>>      preparedStatements;
	...
	public MySQLTableOutputData()
	{
        ...
        preparedStatements = new Hashtable<String, Map<Integer,PreparedStatement>>(); 
